...
<h3></h3>
	...
	<fieldset>
	    <h3 style="margin-left:-8%;" class="display"><a href="es/index.php" style="text-decoration:none;color:#0f602d">Spanish</a></h3>
...
<h3 style="" class="mobilenav"><a href="es/index.php" style="text-decoration:none;color:#0f602d">Spanish</a></h3>
<?php 
...
<div class="fieldset-content" style="margin-top:0px !important; margin-left:50px">
    <!--<label class="form-label">Comming Soon</label>-->
 <label class="form-label">Enter your Personal Information</label>
...
<input type="text" name="first_name" id="first_name" placeholder="First Name" value="<?php echo $_GET['first_name'];?>" required/>
<input type="text" name="last_name" id="last_name" placeholder="Last Name" value="<?php echo $_GET['last_name'];?>" required/>
<input type="text" name="phone_number" id="phoneNumber" placeholder="Phone: 123-456-7890" value="<?php echo $_GET['phone_number'];?>" required/>

<input type="email" name="email" id="email" placeholder="Email" value="<?php echo $_GET['email'];?>" required/>

<label class="form-label" style="font-size:12px;padding-bottom:0px;color:#0f602d">Date of Birth</label>
<div class="form-row">
...
<label class="form-label" style="font-size:12px;padding-bottom:0px;color:#0f602d" for="member_military"> Are you an active duty member of the military, spouse or dependent of one?</label>

<div class="form-row">
    <div class="form-group" style="width: auto;">
        <select name="member_military" id="member_military" class="form-control" required>
        <option></option>
...
<iframe src="footer_new.php" width="100%"  height="1000px" frameBorder="0" style="overflow-x: hidden;"  onload="resizeIframe(this)"></iframe>
</div>
