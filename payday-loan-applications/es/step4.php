...
<div class="fieldset-content">
 <label class="form-label">Ingrese sus 3 Extractos Bancarios más Recientes</label>
...
<input type="file" name="doc1" id="doc1" placeholder="Declaración 1" />

<input type="file" name="doc2" id="doc2" placeholder="Declaración 2" />

<input type="file" name="doc3" id="doc3" placeholder="Declaración 3" />
...
<div class="form-group" style="width: auto;">
    	<button name="submit-form" type="submit" class="button">Terminar</button>
