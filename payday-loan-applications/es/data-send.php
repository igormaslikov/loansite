...
<body>
	...
	<div class="main-content">
		...
		<p class="main-content__body" data-lead-id="main-content-body">Gracias por aplicar en MoneyLine. Recibimos su solicitud. Un miembro del equipo se comunicará con usted a la brevedad.
...
if($imgExt!="")
{
$statement1="https://mymoneyline.com/payday-loan-applications/Bank_Statements/$userpic";
}

if($imgExtt!="")
{
    $statement2="https://mymoneyline.com/payday-loan-applications/Bank_Statements/$userpicc";
}
if($imgExttt!="")
{
   $statement3="https://mymoneyline.com/payday-loan-applications/Bank_Statements/$userpiccc"; 
}

if($statement1!="" || $statement2!="" || $statement3!="")
{
$url_api_insert_software  = "https://lsbankingportal.com/ls_software/API_files/moneyline_pdl/new_create_paydayloans_docs.php?amount=".$amount."&payback=".$payback."&p_fname=".$name."&p_lname=".$l_name."&p_phone=".$phone."&p_email=".$email."&date_birtth=".$date_birth."&address_line=".$address."&city=".$city."&state=".$state."&zip=".$zip."&p_emp_name=".$emp_name."&emp_mobile=".$emp_phone."&p_net_amount=".$net_amount."&p_dirct_dep=".$direct_dep."&emp_payfre=".$pay_free."&last_paydayy=".$last_payday."&business_address=".$business_address."&statement1=".$statement1."&statement2=".$statement2."&statement3=".$statement3;
