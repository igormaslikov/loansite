...
<div class="fieldset-content">
 ...
 <label class="form-label">Ingrese su Información de Dirección</label>
...
<input type="text" name="address" id="address" placeholder="Dirección" value="<?php echo $_GET['address'];?>" required/>

<input type="text" name="city" id="city" placeholder="Ciudad" value="<?php echo $_GET['city'];?>" required/>

 <select name="state" id="state" style="height: 42px;margin-bottom: 4px;" required>
    <option value="">Seleccione Estado</option>
<option value="CA" <?php if($_GET['state']=='CA'){ echo 'selected';} ?>>CA</option>
<option value="AZ" <?php if($_GET['state']=='AZ'){ echo 'selected';} ?>>AZ</option>
<option value="NV" <?php if($_GET['state']=='NV'){ echo 'selected';} ?>>NV</option>
<option value="IL" <?php if($_GET['state']=='IL'){ echo 'selected';} ?>>IL</option>
</select>

<input type="number" name="zip" id="zip" placeholder="Código Postal" value="<?php echo $_GET['zip'];?>" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==5) return false;" required/>
...
<iframe src="footer_es.php" width="100%"  height="1000px" style="overflow-x: hidden;" frameBorder="0" onload="resizeIframe(this)"></iframe>
</div>
